...
label_szczegoly_obiketu_miejscowosc = Label(ramka_szczegoly_obiektow, text="Miejscowość:")
label_szczegoly_obiketu_miejscowosc.grid(row=1, column=4)

label_szczegoly_obiketu_miejscowosc_wartosc = Label(ramka_szczegoly_obiektow, text="....")
label_szczegoly_obiketu_miejscowosc_wartosc.grid(row=1, column=5)

label_szczegoly_obiketu_posts = Label(ramka_szczegoly_obiektow, text="Posty:")
label_szczegoly_obiketu_posts.grid(row=1, column=6)

label_szczegoly_obiketu_posts_wartosc = Label(ramka_szczegoly_obiektow, text="....")
label_szczegoly_obiketu_posts_wartosc.grid(row=1, column=7)
